...
if (isset($_GET['path_id']) && $_GET['path_id'] != '') {
    $_SESSION['path_id'] = htmlspecialchars($_GET['path_id']);
}
// module_id
if (isset($_GET['module_id']) && $_GET['module_id'] != '') {
    $_SESSION['lp_module_id'] = htmlspecialchars($_GET['module_id']);
}
...
if ($module['contentType'] == CTSCORM_ || $module['contentType'] == CTSCORMASSET_) {
    $nameTools = "$langModify $langSCORMTypeDesc";
}
if ($module['contentType'] == CTEXERCISE_) {
    $nameTools = "$langModify $langExerciseAsModuleLabel";
}
if ($module['contentType'] == CTDOCUMENT_) {
    $nameTools = "$langModify $langDocumentAsModuleLabel";
}
if ($module['contentType'] == CTLINK_) {
    $nameTools = "$langModify $langLinkAsModuleLabel";
}
if ($module['contentType'] == CTCOURSE_DESCRIPTION_) {
    $nameTools = "$langModify $langCourseDescriptionAsModuleLabel";
}
if ($module['contentType'] == CTLABEL_) {
    $nameTools = "$langModify $langModuleOfMyCourseLabel_onom";
}

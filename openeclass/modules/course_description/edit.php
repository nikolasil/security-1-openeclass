...
if ($is_adminOfCourse) {
        if (isset($_POST['save'])) {
                ...
                $tool_content .= "<p class='success'>$langBlockDeleted<br /><br /><a href='$_SERVER[SCRIPT_NAME]'>$langBack</a></p>";
      ...
      <td><select name='numBloc' size='1' class='auth_input'>";
    		...
    		<p>&nbsp;</p>
                ...
                while (list($numBloc,) = each($titreBloc)) {
					...
					<a href='" . $_SERVER['SCRIPT_NAME'] . "?numBloc=" . $numBloc . "' >
					<img src='../../template/classic/img/edit.gif' border='0' title='$langModify' /></a>&nbsp;&nbsp;";
                                $tool_content .= "<a href='$_SERVER[SCRIPT_NAME]?delete=yes&amp;numBloc=$numBloc' onClick='return confirmation();'><img src='../../images/delete.gif' border='0' title='$langDelete' /></a>&nbsp;</td></tr></thead></table>
      					</td></tr><tr>
